...
const mockMatches = [
  {
    ...
    logo: "🏟️",
    lastMessage: {
      preview: "Super ! On aimerait discuter des détails...",
      timestamp: "Il y a 2h",
    },
    unreadCount: 2,
    status: "active",
  },
  {
    ...
    logo: "⚽",
    lastMessage: {
      preview: "Quand es-tu disponible pour un essai ?",
      timestamp: "Hier",
    },
    unreadCount: 0,
    status: "active",
  },
  {
    ...
    logo: "🎯",
    lastMessage: {
      preview: "Merci pour ton intérêt !",
      timestamp: "Il y a 3j",
    },
    unreadCount: 1,
    status: "active",
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Badge className="bg-primary text-primary-foreground">
            {mockMatches.filter(m => m.unreadCount > 0).length} nouveaux
          </Badge>
        </div>
        ...
        {mockMatches.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-bold mb-2">Aucun match pour le moment</h3>
            <p className="text-muted-foreground">
              Commence à swiper pour trouver des clubs
            </p>
          </div>
        )}
      </div>
